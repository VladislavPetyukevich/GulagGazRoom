...
public class RoomServiceTest
{
    ...
    public async Task PatchUpdateRoomWithRequestNameIsNotNull()
    {
        ...
        var roomService = new RoomService(roomRepository, new RoomQuestionRepository(appDbContext), new QuestionRepository(appDbContext), new UserRepository(appDbContext), new EmptyRoomEventDispatcher(), new RoomQuestionReactionRepository(appDbContext), new AppEventRepository(appDbContext), new RoomParticipantRepository(appDbContext));
