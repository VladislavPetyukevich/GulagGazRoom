...
public sealed class RoleName : SmartEnum<RoleName>
{
    ...
    public static readonly RoleName User = new RoleName(Guid.Parse("ab45a82b-aa1c-11ed-abe8-f2b335a02ee9"), "User", 1);
    public static readonly RoleName Admin = new RoleName(Guid.Parse("ab45cf57-aa1c-11ed-970f-98dc442de35a"), "Admin", 2);
